...
export const metadata = {
  title: "Privacy Policy — Memebooq",
  description: "How Memebooq collects, uses, and protects your data.",
};
...
const sections: DocSection[] = [
  {
    ...
    heading: "Overview",
    body: [
      "This Privacy Policy explains what information Memebooq (\"we\", \"us\") collects when you use the platform, how we use it, and the choices you have. By using Memebooq you agree to the practices described here.",
    ...
    body: [
      {
        list: [
          ...
          "To improve Memebooq — understand what's working and fix what isn't.",
  ...
  },
  {
    ...
    body: [
      "Memebooq is built on public blockchains. Transactions such as reward payouts are recorded on-chain and are permanent and publicly visible. Your wallet address and any associated activity may be viewable by anyone.",
  ...
  },
  {
    ...
    heading: "Children",
    body: [
      "Memebooq is not directed to anyone under 18 (or the age of majority in your jurisdiction). We do not knowingly collect data from children.",
    ],
  },
  {
    id: "changes",
...
export default function PrivacyPage() {
  return (
    <LegalLayout
      ...
      intro="What we collect, how we use it, and the control you have over your data on Memebooq."
